...
<body>
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li><a href="${pageContext.request.contextPath}/customer/logOut.action"><i class="fa fa-sign-out fa-fw"></i>
							退出登录</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div id="addCustomer">
						<!-- /.panel-body -->
											<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick="addCustomerForm()">添加用户</a>
						</div>
					</div>
					<!-- /.panel -->
				</div>
	...
	<div class="modal fade" id="customerEditDialog" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header" id="updateDiv1">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
					<h4 class="modal-title" id="myModalLabel">修改客户信息</h4>
				</div>
				<div class="modal-body" id="updateDiv2">
				...
				<div class="modal-footer" id="updateDiv3">
					<div id="close"><button type="button" class="btn btn-default" data-dismiss="modal">关闭</button></div>
					<div id="updateDiv"><input type="button" id="updateOne" class="btn btn-primary" onclick="updateCustomer()" value="保存修改"></div>
					<div id="addDiv"><input type="button" id="addOne" class="btn btn-primary" onclick="addCustomer()" value="确认添加"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function addCustomerForm(){
			$.ajax({
				...
				success:function(data) {  
					...
					document.getElementById("updateOne").style.display="none";
					document.getElementById("addOne").style.display="block";
			 	}
			}); 
			<%-- document.getElementById("updateOne").value="确认添加";
		...
		function addCustomer(){
			$.post("${pageContext.request.contextPath}/customer/add.action",$("#edit_customer_form").serialize(),function(data){		
				alert("客户添加成功！");
				window.location.reload();
			});
		}
		...
		function editCustomer(id) {
			$.ajax({
				...
				success:function(data) {  
					...
					document.getElementById("updateOne").style.display="block";
